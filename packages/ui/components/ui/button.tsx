 ...
 *
 * 🎭 ANALOGY: Think of this as a "costume pattern" for buttons.
 * Instead of designing every button from scratch, we have pre-made
 * patterns (variants) that we can customize:
 *
